...
class ScreenshotParseService : Service() {
    ...
    private lateinit var parser: ScreenshotParser
    private lateinit var session: ScreenshotParseSession
    private lateinit var resultStore: ScreenshotParseResultStore
