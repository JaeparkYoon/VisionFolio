        ...
        Column(modifier = Modifier.weight(1f)) {
            ...
            val detail = when {
                ...
                holding.category.isBond -> {
                    ...
                    "${holding.category.displayName} · ${nf.format(holding.quantity)} ${stringResource(R.string.unit_shares)} · ${holding.currency.name} ${nf.format(holding.currentValue.toLong())}"
                }
            }
            Text(
                detail,
